...
\node[photo] (a) {\includegraphics[height=3.0cm]{Figures/exp_frames/nav_guards.png}};
\node[photo, right=4mm of a] (b) {\includegraphics[height=3.0cm]{Figures/exp_frames/nav_episode.png}};
\node[photo, right=4mm of b] (c) {\includegraphics[height=3.0cm]{Figures/exp_frames/nav_traj.png}};
...
\node[lbl, below=1mm of c] {(c) executed trajectory over modes;\\ \textcolor{red}{red} = recovery segment \textcolor{orange}{orange} shoes perturbation};
\end{tikzpicture}%
}
