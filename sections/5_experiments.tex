...
Over 41 trials (21 nominal, 20 perturbed), we compare SEAL against the open-loop automaton; here we fix the transition threshold and vary start and goal positions to test generalization. Perturbations move target objects, block the gripper, or dislodge the payload mid-transport; as they cannot be replicated exactly, the runs are independent samples, so we evaluate completed trials with the Mann-Whitney $U$ test (failure rates were similar for both).

On nominal runs SEAL matches the baseline's kinematics (no significant difference in time or path length, $p>0.39$, $r\le0.467$) while preserving the task topology exactly: $4.00\pm0.00$ transitions vs the baseline's $4.67\pm1.15$, with a trend toward fewer state-disagreement frames ($17.60\pm13.13$ vs $49.00\pm25.36$; $U{=}1.0$, $p{=}0.071$, $r{=}0.867$). Even unperturbed, rigid thresholds cause spurious switches.

Under perturbation SEAL bounds recovery chattering to $8.00\pm2.77$ transitions (max 13) vs the baseline's $12.71\pm8.88$ (outliers to 31; $U{=}16.0$, $p{=}0.274$, $r{=}0.347$), and trends toward fewer state-estimation mismatches ($56.57\pm33.83$ vs $151.14\pm149.75$; $U{=}10.0$, $p{=}0.073$, $r{=}0.592$); recovery trajectories are also faster ($55.72\pm21.91$\,s vs $68.81\pm35.88$\,s, $p>0.45$, $r\le0.265$). Manual-perturbation variance keeps several gaps short of significance, but the baseline's higher disagreement forces long temporal buffers to avoid runaway switching, which SEAL does not need.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
